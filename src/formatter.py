...
")
    ...
    # Prefixek (kulcsszó után nincs külön sor)
    ...
    # SELECT listában '=' igazítás (vessző bal oldalon feltételezve)
    s = _align_select_equals(s)

    # WHERE/ON operátor igazítás (AND/OR az első feltétel alatt)
